...
with open(l_file,"r", newline='',encoding="utf-8-sig") as csvfile:
    ...
    for row in cov_reader:
        ...
        ag01_m = int(row["Gruppe_<25_M_1"])   + int(row["Gruppe_<25_D_1"])
        ...
        ag01_2_m = int(row["Gruppe_<25_M_2"]) + int(row["Gruppe_<25_D_2"])
        ...
        ag01_2_w = int(row["Gruppe_<25_W_2"]) 
        ...
        newline_g = str(datum + "," + str(ag01_m) + "," + str(ag01_w) + "," +str(ag02_m) + "," + str(ag02_w) + "," +str(ag03_m) + "," + str(ag03_w) + "," +str(ag04_m)+ "," + str(ag04_w) + "," +str(ag05_m)+ "," + str(ag05_w) + "," +str(ag06_m) + "," + str(ag06_w) + "," +str(ag07_m)+ "," + str(ag07_w) + "," +str(ag08_m)+ "," + str(ag08_w) + "," + str(ag01_2_m) + "," + str(ag01_2_w) + "," +str(ag02_2_m) + "," + str(ag02_2_w) + "," +str(ag03_2_m) + "," + str(ag03_2_w) + "," +str(ag04_2_m)+ "," + str(ag04_2_w) + "," +str(ag05_2_m)+ "," + str(ag05_2_w) + "," +str(ag06_2_m) + "," + str(ag06_2_w) + "," +str(ag07_2_m)+ "," + str(ag07_2_w) + "," +str(ag08_2_m)+ "," + str(ag08_2_w) + "," + str(bp_1) + "," + str(bp_2) + "," + str(mo_1) + "," + str(mo_2) + "," + str(az_1) + "," + str(az_2) + "," + str(ja) + "\n")
    ...
    for b in bl:
        ...
        line_g[b].append("Datum,<24_1_m,<24_1_w,25-34_1_m,25-34_1_w,35-44_1_m,35-44_1_w,45-54_1_m,45-54_1_w,55-64_1_m,55-64_1_w,65-74_1_m,65-74_1_w,75-84_1_m,75-84_1_w,>84_1_m,>84_1_w,<24_2_m,<24_2_w,25-34_2_m,25-34_2_w,35-44_2_m,35-44_2_w,45-54_2_m,45-54_2_w,55-64_2_m,55-64_2_w,65-74_2_m,65-74_2_w,75-84_2_m,75-84_2_w,>84_2_m,>84_2_w,bp_1,bp_2,mo_1,mo_2,az_1,az_2,ja\n")
for b in bl:
